...
alias porucznik='ssh m.budzynski@porucznik'
alias target="ssh root@192.168.129.3"
...
alias rights='git log -p --no-color --after=`date +%Y.%m.01 -d "this month"` --before=`date +%Y.%m.01 -d "next month"` --author="budzynski" --author="Budzynski" --author="Budzyński"'
